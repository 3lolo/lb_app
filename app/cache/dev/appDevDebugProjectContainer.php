...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.message_controller' => 'getApp_MessageControllerService',
    ...
    /**
     * Gets the 'app.message_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\MessagesController A AppBundle\Controller\MessagesController instance.
     */
    protected function getApp_MessageControllerService()
    {
        return $this->services['app.message_controller'] = new \AppBundle\Controller\MessagesController();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'jobeet', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fabc22bde03af7180b2cbe8715591595e0144dc4e96e0f663d61b060f99b6f20');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('86c325b2c7d46f5d1e4c774985cfe5d4a76896fd');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56728cc542d840.34312290')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '86c325b2c7d46f5d1e4c774985cfe5d4a76896fd',
            'locale' => 'en',
            ...
            'kernel.secret' => '86c325b2c7d46f5d1e4c774985cfe5d4a76896fd',
